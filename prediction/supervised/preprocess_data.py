...
def preprocess(clean_filled):
    ...
    dump(ordinal_encoder, 'prediction/supervised/models/severity_encoder.joblib')
    dump(minmax_scaler, 'prediction/supervised/models/severity_minmax_scaler.joblib')
    dump(standard_scaler, 'prediction/supervised/models/severity_standard_scaler.joblib')
...
def preprocess_input_data(raw_data):
    ...
    # Initialize scalers
    minmax_scaler = load('prediction/supervised/models/severity_minmax_scaler.joblib')
    standard_scaler = load('prediction/supervised/models/severity_standard_scaler.joblib')
...
def get_prediction(input_data):
    ...
    model = load('prediction/supervised/models/severity_predictor_dt.joblib')
    prediction = model.predict(data)

    # Inverse transform the ordinal encoding
    ordinal_encoder = load('prediction/supervised/models/severity_encoder.joblib')
